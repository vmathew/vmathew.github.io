...
This is the fourth post in a series on running generative AI in a regulated enterprise. It started with the argument that [AI governance is the new cloud security](/ai/governance/2024/09/01/ai-governance-is-the-new-cloud-security.html): the same discipline that took cloud from "please be careful" to enforced, auditable controls now has to be applied to AI. The [second post](/ai/governance/2024/10/01/guardrail-enforcement-must-live-in-your-scps.html) put that into practice for guardrails, arguing enforcement must live in your SCPs. The [third](/ai/governance/2026/07/01/cost-attribution-for-llm-usage.html) made the same argument for cost attribution: make the tags unforgeable, don't ask developers to remember.
